...
export class MultipleChoiceAnswerClickedEvent {
  ...
  public static subscribe(
    eventHandler: (event: MultipleChoiceAnswerClickedEvent) => void
  ) {
...
export class NextMultipleChoiceQuestionLoadedEvent {
  ...
  public static subscribe(
    eventHandler: (event: NextMultipleChoiceQuestionLoadedEvent) => void
  ) {
    addGlobalEventListener(
      NextMultipleChoiceQuestionLoadedEvent.EVENT_NAME,
      (x) => {
